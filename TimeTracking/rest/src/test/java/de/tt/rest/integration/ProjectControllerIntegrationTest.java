...
import de.tt.rest.controller.ProjectController;
...
public class ProjectControllerIntegrationTest extends AbstractControllerIntegrationTest<ProjectEntity> {

    @MockBean
    private ProjectService projectService;

    private JacksonTester<ProjectEntity> jsonProjectEntity;
...
//        ProjectEntity entityToTest = readFromFile(data + "project.json");
