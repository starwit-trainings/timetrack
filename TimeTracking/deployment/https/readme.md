This is configured for running on server for domain pb.tt.de.
...
* 7. checkout project and go to `/timetracking/deployment/https`
...
* 10. execute `timetracking-docker-compose up -d` and `env-docker-compose up -d`
...
* go to https://pb.startwit.de/auth, login and create user for timetracking
